...
test('1 ft to km = 0.0003048', () => { expect(length('1', 'ft', 'km')).toBe(0.0003048) })
test('1 ft to m = 0.3048', () => { expect(length('1', 'ft', 'm')).toBe(0.3048) })
test('1 ft to cm = 30.48', () => { expect(length('1', 'ft', 'cm')).toBe(30.48) })
test('1 ft to mm = 304.8', () => { expect(length('1', 'ft', 'mm')).toBe(304.8) })
test('1 ft to μm = 304800', () => { expect(length('1', 'ft', 'μm')).toBe(304800) })
test('1 ft to nm = 304800000', () => { expect(length('1', 'ft', 'nm')).toBe(304800000) })
test('1 ft to mi = 0.000189394', () => { expect(length('1', 'ft', 'mi')).toBe(0.000189394) })
test('1 ft to yd = 0.333333', () => { expect(length('1', 'ft', 'yd')).toBe(0.333333) })
test('1 ft to ft = 1', () => { expect(length('1', 'ft', 'ft')).toBe(1) })
test('1 ft to in = 12', () => { expect(length('1', 'ft', 'in')).toBe(12) })

test('1 in to km = 0.0000254', () => { expect(length('1', 'in', 'km')).toBe(0.0000254) })
test('1 in to m = 0.0254', () => { expect(length('1', 'in', 'm')).toBe(0.0254) })
test('1 in to cm = 2.54', () => { expect(length('1', 'in', 'cm')).toBe(2.54) })
test('1 in to mm = 25.4', () => { expect(length('1', 'in', 'mm')).toBe(25.4) })
test('1 in to μm = 25400', () => { expect(length('1', 'in', 'μm')).toBe(25400) })
test('1 in to nm = 25400000', () => { expect(length('1', 'in', 'nm')).toBe(25400000) })
test('1 in to mi = 0.0000157828', () => { expect(length('1', 'in', 'mi')).toBe(0.0000157828) })
test('1 in to yd = 0.0277778', () => { expect(length('1', 'in', 'yd')).toBe(0.0277778) })
test('1 in to ft = 0.0833333', () => { expect(length('1', 'in', 'ft')).toBe(0.0833333) })
test('1 in to in = 1', () => { expect(length('1', 'in', 'in')).toBe(1) })
